...
glass2 = gr.material( {0.05, 0.05, 0.05}, {0.7, 0.7, 0.7}, 25, {0,0,0,0}, 1.5)	
...
mirror_sphere1:set_material(glass2)
...
-- mirror_sphere2:translate(0, 4, 0)
...
-- mirror_sphere3:translate(5, 4, 0)
...
-- mirror_sphere4:translate(-5, -4, 0)
...
-- mirror_sphere5:translate(0, -4, 0)
...
-- mirror_sphere6:translate(5, -4, 0)
...
gr.render(scene, 'the_room.png', 256, 256,
