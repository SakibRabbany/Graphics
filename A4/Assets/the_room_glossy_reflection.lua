...
mirror1 = gr.material( {0.0, 0.0, 0.0},   {1.0, 1.0, 1.0},	25,{0,0.1,0,0}, 0.0)
mirror2 = gr.material( {0.0, 0.0, 0.0},   {1.0, 1.0, 1.0},	25,{0,1,0,0}, 0.0)
mirror3 = gr.material( {0.0, 0.0, 0.0},   {1.0, 1.0, 1.0},	25,{0,10,0,0}, 0.0)
mirror4 = gr.material( {0.0, 0.0, 0.0},   {1.0, 1.0, 1.0},	25,{0,100,0,0}, 0.0)
mirror5 = gr.material( {0.0, 0.0, 0.0},   {1.0, 1.0, 1.0},	25,{0,1000,0,0}, 0.0)
mirror6 = gr.material( {0.0, 0.0, 0.0},   {1.0, 1.0, 1.0},	25,{0,10000,0,0}, 0.0)
...
mirror_sphere1:set_material(mirror1)
mirror_sphere1:scale(2, 2, 2)
mirror_sphere1:translate(-5, 4, 4)


mirror_sphere2 = gr.sphere('mirror_sphere2')
scene:add_child(mirror_sphere2)
mirror_sphere2:set_material(mirror2)
...
mirror_sphere3:set_material(mirror3)
...
mirror_sphere4:set_material(mirror4)
...
mirror_sphere5:set_material(mirror5)
...
mirror_sphere6:set_material(mirror6)
...
gr.render(scene, 'the_room_glossy_reflection_3.png', 256, 256,
